...
var _dompurify = __webpack_require__(295);
...
function searchResultsHTML(stores) {
    return stores.map(function (store) {
        // map through stores and return html for each
...
function typeAhead(search) {
    ...
    searchInput.on('input', function () {
        ...
        _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
            if (res.data.length) {
                // sanitize to prevent injecting HTML
                searchResults.innerHTML = _dompurify2.default.sanitize(searchResultsHTML(res.data)); // send result array to turn into html
                return;
            }
